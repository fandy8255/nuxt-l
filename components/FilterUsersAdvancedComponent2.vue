  ...
  export default {
    ...
    methods: {
      ...
      async fetchFilteredUsers() {
        ...
        if (this.filters.minReportedProducts) params.append("minReportedProducts", this.filters.minReportedProducts);
        if (this.filters.maxReportedProducts) params.append("maxReportedProducts", this.filters.maxReportedProducts);
