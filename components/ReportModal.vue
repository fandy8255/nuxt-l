                    ...
                    <form @submit.prevent="submitReport">
                        ...
                        <div class="mb-3">
                            ...
                            <select v-model="reportReason" id="reason" class="form-select" required>
                                ...
                                <option value="En contra de nuestros términos de uso">En contra de nuestros términos de
                                    uso</option>
                        ...
                        <div v-if="reportReason === 'Otro'" class="mb-3">
                            ...
                            <textarea v-model="customReason" id="customReason" class="form-control" rows="3" required
                                minlength="50" maxlength="100"></textarea>
